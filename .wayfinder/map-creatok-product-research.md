...
Standing sources:
- Primary planning doc: `docs/design/beauty-marketing-agent-product-design-2026-07-17.md`（D-001~D-038 合并权威版；`合集-v1.5-P0决策定稿.md` 已于 2026-07-17 正式退役为历史决策档案）
- Local reference root: `references/`
- CreatOK research root: `references/creatok/`
- Decision records: `docs/adr/0001~0012`（0002 已 superseded by 0006；0008 有 2026-07-11/2026-07-17 两次修订节）
