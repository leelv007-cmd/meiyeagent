...
const loadPromptSelectDialog = () =>
	import("@/components/prompts/prompt-select-dialog").then(
		(module) => module.PromptSelectDialog,
	);
const PromptSelectDialog = dynamic(loadPromptSelectDialog, {
	ssr: false,
	loading: () => null,
});
