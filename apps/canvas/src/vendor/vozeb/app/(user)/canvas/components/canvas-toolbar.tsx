...
export function CanvasToolbar({
	...
	useEffect(() => {
		...
		const closeOnOutside = (event: PointerEvent) => {
			...
			if (
				...
				(target.closest(".canvas-appearance-panel") ||
					target.closest(".canvas-toolbar-dock"))
			)
				return;
	...
	return (
		<div className="canvas-toolbar-dock-wrap pointer-events-none absolute bottom-5 z-50 flex justify-center">
			...
			<div
				ref={wrapRef}
				className="canvas-toolbar-dock thin-scrollbar pointer-events-auto flex h-14 max-w-full items-center gap-1 overflow-x-auto rounded-xl border px-2 shadow-lg backdrop-blur [&>*]:shrink-0"
				style={dockStyle}
			>
				<ToolbarButton
					id="tool-hand"
...
function DockTip({
	...
	return (
		<span
			className="canvas-toolbar-dock-tip absolute bottom-[calc(100%+8px)] -translate-x-1/2 rounded-md px-2 py-1 text-xs shadow-lg"
