...
export function CanvasZoomControls({
	...
	return (
		<div
			role="toolbar"
			aria-label="画布缩放控制"
			className="canvas-zoom-controls pointer-events-none absolute bottom-5 left-5 z-50"
			onMouseDown={(event) => event.stopPropagation()}
			onPointerDown={(event) => event.stopPropagation()}
		>
			<div
				className="canvas-zoom-dock pointer-events-auto flex h-14 items-center gap-1 rounded-xl border px-2 shadow-lg backdrop-blur"
				style={dockStyle}
			>
