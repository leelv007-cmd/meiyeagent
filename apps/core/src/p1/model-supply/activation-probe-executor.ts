...
// 16x16 white PNG: providers enforce a minimum reference size (Seedream
// rejects anything under 14px), so the sanitized probe reference must be
// at least that large while staying a few dozen bytes.
