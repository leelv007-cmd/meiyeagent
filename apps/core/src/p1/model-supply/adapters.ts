  ...
  implements ProviderExecutionPort, MediaProviderLifecyclePort
{
  ...
  reportHealth(): MediaProviderHealthReport {
    ...
    if (provider?.reportHealth)
      return provider.reportHealth() as MediaProviderHealthReport;
    return {
      state: 'unavailable',
  ...
  implements ProviderExecutionPort, MediaProviderLifecyclePort
{
  ...
  setDrainMode(mode: MediaProviderDrainMode) {
    return this.media.setDrainMode(mode);
  }
