...
type ImageCatalogModelId = 'gpt-image-2' | 'seedream-5-pro';
const MAX_PROVIDER_IMAGE_BYTES = 25 * 1024 * 1024;
const MAX_PROVIDER_VIDEO_BYTES = 250 * 1024 * 1024;

export interface ProviderAssetFetchPort {
  get(target: string, constraints: SafeFetchConstraints): Promise<SafeFetchResult>;
}
