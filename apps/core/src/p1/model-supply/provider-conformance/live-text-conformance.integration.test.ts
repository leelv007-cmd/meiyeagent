 ...
 *
 * Channel matrix (handoff 2026-07-20):
 * - official_direct: Volcengine Ark text (ARK_TEXT_* / MODEL_DIRECT as fallback when marked official)
 * - upstream_reseller: tuzi / OpenAI-compatible (MODEL_DIRECT_*)
 *
