                ...
                run.runId === input.workflowId
                  ? {
                      ...
                      actualCatalogModelId:
                        input.routeSnapshot.actualCatalogModelId,
                      ...(input.routeSnapshot.apiCounterparty
                        ? {
                            apiCounterparty:
                              input.routeSnapshot.apiCounterparty,
                          }
                        : {}),
                      providerAttempts: structuredClone(
                        input.providerAttempts
                      ),
                      providerCosts: structuredClone(input.providerCosts),
                      ...(input.routeSnapshot.providerModel
                        ? { providerModel: input.routeSnapshot.providerModel }
                        : {}),
                      routeSnapshot: {
                        actualCatalogModelId:
                          input.routeSnapshot.actualCatalogModelId,
                        catalogRevisionId:
                          input.routeSnapshot.catalogRevisionId,
                        deploymentId: input.routeSnapshot.deploymentId,
                        id: input.routeSnapshot.id,
                        ...(input.routeSnapshot.apiCounterparty
                          ? {
                              apiCounterparty:
                                input.routeSnapshot.apiCounterparty,
                          ...
                          : {}),
                        ...(input.routeSnapshot.endpointRevision
                          ? {
                              endpointRevision:
                                input.routeSnapshot.endpointRevision,
                            }
                      ...
                      routeSnapshotId: input.routeSnapshot.id,
                      status: 'succeeded' as const,
                    }
                  : run
              ),
