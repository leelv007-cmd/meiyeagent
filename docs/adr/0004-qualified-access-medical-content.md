...
> **2026-07-17 修订（D-025 / D-026）**：资质准入机制、offline gate、行为红线仍有效；但「P0 serves medical/aesthetic merchants」与「pilot re-includes 1-2 medical merchants as probes」按 D-025 收窄——医疗美容仅作独立研究探针，与首发（Wave 1）任务频次、采用率、成功指标、能力放行结论分账；D-026 两波进场（4–7 家 → 扩至 8–12 家）均为非医疗首发范围门店。
