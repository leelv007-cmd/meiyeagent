...
- Ticket 21: activation probes use sanitized fixed image/video probe inputs, `productUsageQuantity: 0`, the production submit/poll/download lifecycle, classified errors, cancellation conformance, observed provider cost, and configuration-revision-bound evidence. No Vozeb-derived fixture was copied because the A2/A3 authorization manifest is still blocked.
