...
| C7 | 素材授权与撤权（撤权后 fail closed、可换素材、不重复扣费） | §37.4-F | `v31-rights-revocation-journey` | **降级可用**（08-13 收口：V31-84 修毕，上传/授权链活体走通；素材库→composer 挂源缺口 V31-88＋同图重传 409 砖 V31-87；撤权仍未走查） | V31-87、V31-88 |
