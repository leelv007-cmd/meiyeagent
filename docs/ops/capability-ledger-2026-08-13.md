...
| C7 | 素材授权与撤权（撤权后 fail closed、可换素材、不重复扣费） | §37.4-F | `v31-rights-revocation-journey` | **降级可用**（08-13 收口：上传→授权→composer 挂源全链活体通=V31-84/88 已修；余=同图重传 409 砖 V31-87、撤权链未走查） | V31-87 |
