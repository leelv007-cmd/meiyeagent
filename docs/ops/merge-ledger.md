...
| d322ca07 | #267 | adjust 语义绑定收紧（冻结 snapshot 语义 exact 绑定/篡改 fail closed/output count 冻结进 deliverable+reservation，cherry-pick 自 83055ffa；前两笔 8ec79eac/6bd6ec99 patch-id 等价于已合入 2b8fad7d/745b2702） | contracts 111/0＋双 tsc 0＋焦点三件 29/0（合入态）；lane 侧全量 4547/0＋双 e2e 绿 | 关票待合入态双 e2e 终验 |
