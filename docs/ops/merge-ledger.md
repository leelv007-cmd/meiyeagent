...
| 8e442346 | — | e2e 基建 hotfix：P1 worker 块补 HARNESS_DBOS_SYSTEM_DATABASE_URL（701ef89e 信号化后 worker 终态通知从未接通，image/video 全旅程吃满 150s 超时；契约测试改按块计数 2） | 契约测试 2/0；image/video 双旅程 e2e 复验进行中 | 诊断裁决 a＝e2e 双进程拓扑接线缺陷；copy inline 不受影响；主控直接提交 |
