...
| V31-91 | [显式 start 间歇性 409 COMPOSER_PLAN_START_FAILED：确认落库与 /start 之间存在竞态](V31-91-composer-plan-start-409-race.md) | in progress（2026-08-16）— ①可区分已落地：十处裸抛改为十个码（下次红即可读出是哪一支）；②定位竞态方、③不加重试 未动 |
