...
| V31-65 | [admin 敏感词「分类」控件换 shadcn Select 后 e2e 仍按原生 `<select>` 断言](V31-65-admin-sensitive-words-select-contract.md) | open（2026-08-12）— 验收整案本地绿（select 修复＋V31-68 降级落地，1 passed/44.8s 零 console 错误）；awaiting CI |
