...
| V31-104 | [`p2-browser-acceptance` 里两条 spec 五次恒红，且在零代码 diff 上照样红：无人认领，待定性](V31-104-p2-two-specs-persistently-red-unowned.md) | open（2026-08-16）— 五次观测五红、失败的恒为同两条 spec；**两轮发生在纯文档 PR 上，第五次是同一 commit 的 attempt 2 重跑**，故与被合入的内容无关；是产品缺陷还是风暴级联**未定性**，本票就是去定这个性 |
