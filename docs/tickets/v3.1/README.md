...
| V31-45 | [derived_revision 直写路径不报价不计费，与商家文案承诺矛盾](V31-45-derived-revision-billing-bypass.md) | 已修待关 |
...
| V31-107 | [make-steering 完整修：进度表补 label/page_index，分类器读真进度，§5.6「页已生成后」计费口径重裁](V31-107-make-steering-progress-schema-and-post-generation-billing.md) | 已修待关 |
