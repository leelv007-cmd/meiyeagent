...
**Evidence SHA**: 23263037762ef998d4a3228e7f3d2856f7173f39
**Workflow Run**:
**Artifact Digest**: sha256:e12a1a1b6e3dd036ad382120e5dc1f9c1f9ea5286950e23f20956f09038d2141
...
3. 本文件的 results 行必须携带 `persistence-file-provision/v1` receipt，绑定
   ...
   四组合求交，任一交集即红。
4. 精确 Integration SHA `232630377` 上的完整 focused runner 使用真实本地 PostgreSQL：
