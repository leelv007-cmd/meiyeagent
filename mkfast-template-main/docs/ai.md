...
> **已退役**：`/ai` playground 路由已在本 fork 移除（`tests/e2e/TEST-CATALOG.md` §1.3 验收其返回 404）。本页仅为 TanStarter 模板参考文档，不描述本产品能力；本产品的 AI 执行位于 Core 服务侧（见仓库根 `docs/adr/0006-p0-runtime-topology.md` 与 `docs/design/beauty-marketing-agent-product-design-2026-07-17.md` Implementation Boundary）。
