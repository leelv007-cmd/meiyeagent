...
const PRODUCT_SHELL_SOURCES = [
  ...
  'src/p1/operations-route-model.ts',
  'src/p1/operations-view-model.ts',
  'src/p1/retrieval-facets.ts',
  'src/p1/retrieval-search.tsx',
  'src/p1/settings-view-model.ts',
  'src/p1/template-catalog.tsx',
  'src/p1/use-integration-settings.ts',
  'src/p1/weekly-operations.tsx',
  ...
  'src/product/copy-candidate-selector-model.ts',
  'src/product/copy-candidate-selector.tsx',
  'src/product/copy-stream.tsx',
  'src/product/creative-quote.ts',
  'src/product/creative-work-display.ts',
  'src/product/creation-assistant-context.ts',
  'src/product/creation-assistant.tsx',
  'src/product/creation-catalog-model.ts',
  'src/product/creation-entry-model.ts',
  'src/product/creation-entry.tsx',
  'src/product/creation-shelf-model.ts',
  ...
  'src/product/mobile-upload-session.ts',
  'src/product/model-card-picker.tsx',
  'src/product/operations-rail.tsx',
