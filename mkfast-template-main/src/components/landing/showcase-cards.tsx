...
import {
  ...
  landing_showcase_2_title,
  landing_showcase_3_desc,
  landing_showcase_3_title,
  landing_showcase_cta,
...
export function ShowcaseCards(): ReactNode {
  ...
  const cards: CardData[] = [
    {
      title: landing_showcase_1_title(),
      description: landing_showcase_1_desc(),
      image: '/seed/asset/asset-nail-aurora.webp',
    },
    {
      title: landing_showcase_2_title(),
      description: landing_showcase_2_desc(),
      image: '/seed/preset/preset-price-card.webp',
    },
    {
      title: landing_showcase_3_title(),
      description: landing_showcase_3_desc(),
      image: '/seed/model/model-image-beauty.webp',
    },
  ];

  return (
    <section id="showcase" className="px-4 py-20 sm:px-6 md:py-28 lg:px-8">
