            ...
            >
              ...
              <div className="relative mt-6 aspect-3/4 w-full h-80 overflow-hidden">
                <img
                  ...
                  loading="lazy"
                  draggable={false}
                  className="absolute inset-0 h-full w-full object-contain object-top scale-90 grayscale"
                />
              </div>
            </motion.div>
          ))}
