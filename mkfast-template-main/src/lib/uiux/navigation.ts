...
const legacyRedirects = new Map<string, string>([
  ...
  ['/settings/billing', `${Routes.SettingsAccount}?section=credits`],
  ['/settings/credits', `${Routes.SettingsAccount}?section=credits`],
  ['/settings/payment', `${Routes.SettingsAccount}?section=credits`],
