...
| 3 | Pricing tiers speak the pilot contract without a purchase promise | In `#pricing`, verify Starter 免费, Growth ¥399 marked 推荐, and 终身版 disabled 未开放 with no link; assert the block carries no 上线特惠 promo, no 立即购买/订阅/升级 verb, and that the paid CTA is the 兑换码 activation path to `/auth/register`. |
