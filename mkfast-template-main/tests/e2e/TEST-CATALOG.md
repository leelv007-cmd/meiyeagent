...
| 3 | Daily light editor owns Canvas Work routes | Create a blank Canvas Work from the shared catalog, enter its exact `/dashboard/works/:id` route, and verify the daily light editor renders there. |
