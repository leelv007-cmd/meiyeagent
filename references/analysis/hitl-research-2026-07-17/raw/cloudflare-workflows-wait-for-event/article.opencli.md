...
> 发布时间: 2026-04-22T16:32:00.000Z
> 原文链接: https://developers.cloudflare.com/workflows/examples/wait-for-event/
...
-   [JavaScript](#tab-panel-14045)
-   [TypeScript](#tab-panel-14046)
...
-   [wrangler.jsonc](#tab-panel-14043)
-   [wrangler.toml](#tab-panel-14044)

```
{  "$schema": "node_modules/wrangler/config-schema.json",  "name": "workflows-waitforevent",  "main": "src/index.ts",  // Set this to today's date  "compatibility_date": "2026-07-17",  "observability": {    "enabled": true,    "head_sampling_rate": 1,  },  "ai": {    "binding": "AI"  },  "workflows": [    {      "name": "workflows-starter",      "binding": "MY_WORKFLOW",      "class_name": "MyWorkflow"    }  ],  "r2_buckets": [    {      "bucket_name": "workflow-demo",      "binding": "workflow_demo_bucket"    }  ],  "d1_databases": [    {      "binding": "DB",      "database_name": "workflows-demo-d1",      "database_id": "66e4fbe9-06ac-4548-abba-2dc42088e13a"    }  ]}
```

```
"$schema" = "node_modules/wrangler/config-schema.json"name = "workflows-waitforevent"main = "src/index.ts"# Set this to today's datecompatibility_date = "2026-07-17"
