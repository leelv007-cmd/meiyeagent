...
>
> 2026-07-17 追加批注：Scope Lock 保 8 坐标已被合并权威版取代（五类入口发布合同 + 能力门三态，见 docs/design/beauty-marketing-agent-product-design-2026-07-17.md D-023/D-026/D-027 与 ADR-0008 2026-07-17 修订节）；文末所引 09 章硬停止清单的 AIGC 标识条目以 ADR-0008 2026-07-11 修订节与 p0-spec §8 口径为准（关闭可选产品侧 AIGC 开关不属红线，伪造或绕过强制 provider/platform provenance/发布标识才是）；本文为 P0 期 IA 蓝图留档。
